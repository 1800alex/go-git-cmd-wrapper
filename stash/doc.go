/*
Package notes git-stash - Stash the changes in a dirty working directory away.
...
stash without any arguments is equivalent to git stash push. A stash is by default listed as "WIP on
